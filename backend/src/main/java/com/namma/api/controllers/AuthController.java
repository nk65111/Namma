...
public class AuthController {
	...
	@GetMapping("/profile")
	public ResponseEntity<AuthDto> profile() throws PhoneNumberNotFoundException{
		AuthDto auth = authService.getProfile();
		return new ResponseEntity<>(auth, HttpStatus.OK); 
	}
	
	@PutMapping("/profile")
	public ResponseEntity<String> updateProfile(AuthDto authDto){
